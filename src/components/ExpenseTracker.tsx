    ...
    render() {
        const elem = (
            ...
            <section>
                <header>
                    <h1>Add New Item </h1>
                    <p>Read the below Instructions before proceddings: </p>
                    <p>Make sure you fill all the fields where * is provided </p>
                </header>
                <form onSubmit={this.submitForm}>
                 <article>
                    <p>Name</p>
                    <select name="Name" id="" required value={this.state.payeeName} onChange={this.setPayee}></select>
             ...
             <article>
                  ...
                  <p> Date </p>
              <input type="date" required value={this.state.setDate} onChange={this.entryDate}></input>
